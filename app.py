...
# Page config
st.set_page_config(
    page_title="Kanokwan DW Explorer",
    page_icon="📊",
    layout="wide",
...
# Connect to database
DB_PATH = "kanokwan_dw_duckdb/dev.duckdb"
...
st.markdown('<div class="main-title">📊 673020487-7 กนกวรรณ หงษ์โสภา DW Explorer</div>', unsafe_allow_html=True)
